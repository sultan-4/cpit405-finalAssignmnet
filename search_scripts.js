...
processImage(keyword.value)
})

function processImage(keyword){
    if(!keyword){
        return;
    }
...
req.open('GET','https://api.unsplash.com/search/photos?page=1&query='+keyword+'&per_page=12');
